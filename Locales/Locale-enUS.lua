...
L['STRING_ID'] = "id"
L['STRING_INFORM_CHAT_CANNOT_LOG_BN_CHAT_IN_COMBAT'] = "A Battle.net message was sent to you during combat. Those cannot be logged due to Blizzard restrictions."
