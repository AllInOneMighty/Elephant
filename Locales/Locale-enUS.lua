...
L['STRING_GENERAL_CHAT_CHANNEL_NAME_TRADE_SERVICES'] = "Trade (Services)"
...
L['STRING_OPTIONS_MAX_LOG_LINES_DESC_2'] = "This setting is shared with all characters."
...
L['STRING_OPTIONS_SHARE_LOGS_WITH_ALTS_DESC_1'] = "Shares the logs seen by this character with all other characters that have this option enabled."
