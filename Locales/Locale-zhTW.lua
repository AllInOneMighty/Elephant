...
L['STRING_GENERAL_CHAT_CHANNEL_NAME_TRADE_SERVICES_ID'] = "交易 (服務)"
L['STRING_GENERAL_CHAT_CHANNEL_NAME_TRADE_SERVICES_ID_ALT'] = "服務"
L['STRING_GENERAL_CHAT_CHANNEL_NAME_TRADE_SERVICES'] = "交易 (服務)"
...
L['STRING_OPTIONS_FILE_LOGGING_ACTIVATE_DESC_1'] = "讓Elephant控制文件記錄. 禁用此選項將離開當前記錄狀態."
L['STRING_OPTIONS_FILE_LOGGING_ACTIVATE_DESC_2'] = "警告: 你無法同時讓兩個插件控制文件記錄(比如Prat和Elephant)"
L['STRING_OPTIONS_FILE_LOGGING_ACTIVATE'] = "啟用"
L['STRING_OPTIONS_FILE_LOGGING_CHAT_DESC_1'] = "將聊天記錄(不包含戰鬥記錄)保存到Logs\\WoWChatLog.txt."
L['STRING_OPTIONS_FILE_LOGGING_CHAT_DESC_2'] = "注意: 如果此選項已經打開, 進入游戲後將自動啟用."
...
L['STRING_OPTIONS_PRAT_FORMATTING_DESC_1'] = "保存記錄為Prat格式. 設置此選項後所保存的聊天記錄不在為Elephant的默認保存樣式."
L['STRING_OPTIONS_PRAT_FORMATTING_DESC_3'] = "如果你使用Prat插件,此選項將被激活"
L['STRING_OPTIONS_PRAT_FORMATTING'] = "根據 Prat 格式保存記錄"
L['STRING_OPTIONS_RESET_POSITION_DESC'] = "重設 Elephant 視窗位置."
