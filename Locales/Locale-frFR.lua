...
L['STRING_INFORM_CHAT_CANNOT_LOG_BN_CHAT_IN_COMBAT'] = "Vous avez reçu un message Battle.net pendant un combat. Ces messages ne peuvent pas être sauvegardés à cause des restrictions imposées par Blizzard."
