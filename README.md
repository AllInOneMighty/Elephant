...
copy/paste a chat with _colors_ and _links to an item database_ in a very quick
and simple way to your favorite forum.

This is _THE_ addon that you should install if you want to never forget what
